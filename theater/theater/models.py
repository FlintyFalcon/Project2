...
## Don't think directions would be useful as the location is already given.
...
class Movies(models.Model):
	...
	## Changed the Length of the title to 50, because some Movie titles may be longer.
...
class Synopsis(models.Model):
    title = models.CharField(max_length = 50)
	## Same as above for Movies
	summary = model.TextField()
